...
// own function
int Chessboard::augmentBestRun(std::vector<ChessboardQuadPtr> &candidateQuads, int candidateDilation,
...
void Chessboard::generateQuads(std::vector<ChessboardQuadPtr> &quads,
    ...
    for (size_t i = 0; i < contours.size(); ++i) {
        ...
        if (approxContour.size() == 4 && cv::isContourConvex(approxContour)) {
            ...
            if (!(flags & CV_CALIB_CB_FILTER_QUADS) || (d3 * 4 > d4 && d4 * 4 > d3 && d3 * d4 < area * 1.5 && area > minSize && d1 >= 0.15 * p && d2 >= 0.15 * p)) {
...
bool Chessboard::matchCorners(ChessboardQuadPtr &quad1, int corner1,
    ...
    // Check whether conditions are fulfilled
    if (((sign11 < 0 && sign12 < 0) || (sign11 > 0 && sign12 > 0)) && ((sign21 < 0 && sign22 < 0) || (sign21 > 0 && sign22 > 0)) && ((sign31 < 0 && sign32 < 0) || (sign31 > 0 && sign32 > 0)) && ((sign41 < 0 && sign42 < 0) || (sign41 > 0 && sign42 > 0)) && ((sign11 < 0 && sign13 < 0) || (sign11 > 0 && sign13 > 0)) && ((sign21 < 0 && sign23 < 0) || (sign21 > 0 && sign23 > 0)) && ((sign31 < 0 && sign33 < 0) || (sign31 > 0 && sign33 > 0)) && ((sign41 < 0 && sign43 < 0) || (sign41 > 0 && sign43 > 0)) && ((sign51 < 0 && sign52 > 0) || (sign51 > 0 && sign52 < 0)) && ((sign61 < 0 && sign62 > 0) || (sign61 > 0 && sign62 < 0)) && ((sign71 < 0 && sign72 > 0) || (sign71 > 0 && sign72 < 0)) && ((sign81 < 0 && sign82 > 0) || (sign81 > 0 && sign82 < 0))) {
        return true;
    } else {
        return false;
    }
