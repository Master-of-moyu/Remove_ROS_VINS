...
public:
    ...
    ReprojectionError3(const std::vector<double> &intrinsic_params,
        ...
        m_intrinsic_params(intrinsic_params),
        m_odo_pos(odo_pos), m_odo_att(odo_att), m_observed_p(observed_p), m_optimize_cam_odo_z(optimize_cam_odo_z) {
    }
    ...
    ReprojectionError3(const std::vector<double> &intrinsic_params,
                       ...
                       const Eigen::Vector2d &observed_p) :
        m_intrinsic_params(intrinsic_params),
        m_cam_odo_q(cam_odo_q), m_cam_odo_t(cam_odo_t), m_odo_pos(odo_pos), m_odo_att(odo_att), m_observed_p(observed_p), m_optimize_cam_odo_z(true) {
    }
...
public:
    ...
    StereoReprojectionError(const Eigen::Vector3d &observed_P,
        ...
        m_observed_P(observed_P),
        m_observed_p_l(observed_p_l), m_observed_p_r(observed_p_r) {
    }
